(() => {
  ...
  function ae(e) {
    ...
    function y(e) {
      ...
      l.touch
        ? (o[p](i.start, C, d), o[p](i.move, T, d), o[p](i.end, S, c))
        : (o[p](n.start, C, d), r[p](n.move, T, d), r[p](n.end, S, c));
    }
    function E() {
      ...
      0 === r.length &&
        ((r = g(`<div class="${t.params.scrollbar.dragClass}"></div>`)),
        n.append(r)),
  ...
  function le() {
    !(function () {
      ...
      document.querySelector(".slider-relax__main") &&
        new te(".slider-relax__main", {
          modules: [ie, re, ae],
          observer: !0,
          observeParents: !0,
          spaceBetween: 10,
            ...
            init: function (e) {
              const t = document.querySelector(".fraction-controll__all"),
                s = document.querySelectorAll(
                  ".slider-relax__slide:not(.swiper-slide-duplicate)"
                );
