...
if (document.querySelector('.images-product')) {
	...
	let productSlider = new Swiper('.images-product__mainslider', {	
	observer: true,
	observeParents: true,
	slidesPerView: 1,
	spaceBetween: 0,
...
//Выезжающая карточка из субменю
...
const priceFilterSlider = document.querySelector('.price-filter__sliderno');
...
function setPriceValues() {
    ...
    priceFilterSlider.noUiSlider.set([priceStartValue, priceEndValue]);
}
